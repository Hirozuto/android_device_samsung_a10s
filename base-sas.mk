PRODUCT_COPY_FILES += \
	device/samsung/a10s/apex-setup.rc:system/etc/init/apex-setup.rc \
...
PRODUCT_COPY_FILES += \
	...
	device/samsung/a10s/environ/init.treble-environ.rc:system/etc/init/init.treble-environ.rc \
